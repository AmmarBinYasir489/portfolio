...
export const projects: Project[] = [
  {
    number: '01', name: 'AI Research Assistant', kind: 'Research agent',
  ...
  {
    number: '02', name: 'Nourish AI', kind: 'Multimodal product',
  ...
  {
    number: '03', name: 'Expense AI', kind: 'Finance platform',
  ...
  {
    number: '04', name: 'Grounded Workspace', kind: 'Knowledge system',
  ...
  {
    number: '05', name: 'Recruiter Portal', kind: 'Recruitment platform',
  ...
  {
    number: '06', name: 'CodeRecall', kind: 'Developer intelligence',
  ...
  {
    number: '07', name: 'AI Stylist', kind: 'Vision product',
  ...
  {
    number: '08', name: 'Hashim Tech Agency', kind: 'Web experience',
